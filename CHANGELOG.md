...
- **SBOM artifact** committed to release tags under
  `sbom/chanvoy-vX.Y.Z.cdx.json` (CycloneDX JSON via Syft). The
  `sbom/` directory is gitignored for dev iteration; release
  artifacts are explicitly committed in the release PR.
